...
function RiskHeatMap({ risks }) {
  ...
  return (
    <div style={{ padding: 16, background: "var(--bg-color)", borderRadius: 12 }}>
      <div style={{ display: "grid", gridTemplateColumns: "25px repeat(5, 1fr)", gap: 3 }}>
        <div />
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} style={{ textAlign: "center", fontSize: "0.6rem", color: "var(--text-light)", fontWeight: 800 }}>
            IMP {i}
          </div>
        ))}
        {levels.map((likelihood) => (
          <span key={likelihood}>
            <div style={{ alignSelf: "center", fontSize: "0.6rem", color: "var(--text-light)", fontWeight: 800 }}>
              L{likelihood}
            </div>
        ...
        <div className="card" style={{ padding: 24, borderRadius: 12, maxWidth: "none" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "stretch", gap: 24 }}>
              ...
              <div style={{ flex: 1, background: "var(--bg-color)", padding: 20, borderRadius: 12, border: "1px solid var(--border-color)" }}>
              ...
              <div style={{ flex: "0 0 200px", display: "flex", flexDirection: "column", gap: 12 }}>
                <div style={{ flex: 1, padding: "12px 16px", background: "var(--bg-color)", borderRadius: 12, border: "1px solid var(--border-color)", textAlign: "center", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 12 }}>
              {(dashboard.insurance_readiness?.requirements || []).slice(0, 5).map((req, i) => (
                <div key={i} style={{ padding: 12, background: "var(--bg-color)", borderRadius: 8, border: "1px solid var(--border-color)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: "0.75rem", color: "var(--text-light)", marginTop: 2 }}>
                      ...
                      <strong
                        style={{
                          color: act.is_na ? "var(--text-light)" : act.answer_index === 0 ? "#22c55e" : act.answer_index === 1 ? "#f59e0b" : "#ef4444",
                        }}
                      >
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.85rem" }}>
                ...
                <tbody>
                  {gapMissing.map((gap, i) => (
                    <tr key={`missing-${i}`} style={{ borderBottom: "1px solid var(--bg-color)" }}>
                  ...
                  {gapPartial.map((gap, i) => (
                    <tr key={`partial-${i}`} style={{ borderBottom: "1px solid var(--bg-color)" }}>
                      <td style={{ padding: "12px 8px", fontWeight: 700, color: "var(--text-main)" }}>{gap.ref}</td>
                      <td style={{ padding: "12px 8px", color: "var(--text-muted)" }}>{gap.domain || "Security"}</td>
                      <td style={{ padding: "12px 8px" }}>
